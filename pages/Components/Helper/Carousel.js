...
export default function Carousel(props) {
    ...
    return (
        <div>
            <div id="controls-carousel" className="relative pt-10" data-carousel="static">

                <div className="relative h-56 overflow-hidden  md:h-96">
                    {
                        props.movies.map((value) => {
                            let img = "https://image.tmdb.org/t/p/w500" + value.backdrop_path
                            return (
                                <div className="visible  duration-700 ease-in-out" data-carousel-item>
